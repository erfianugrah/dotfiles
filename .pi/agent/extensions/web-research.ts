...
const webResearchTool = defineTool({
  name: "web_research",
  label: "Web Research",
  promptSnippet: "web_research — Exa search + auto-fetch top pages. Use for facts / recommendations / disputed answers.",
  promptGuidelines: [
    "mode:'local' for maps/reviews/hours. mode:'fresh' for <1-week-old news/prices.",
  ],
  description: [
    "Exa search + auto-fetch top result pages in one call.",
    "Modes:",
    "- default: Exa + fetch top 2",
    "- local: + Playwright on JS-heavy hosts (maps/yelp)",
    "- fresh: livecrawl=preferred + SearXNG time-filtered cross-check",
    "- crosscheck: Exa + SearXNG, no fetch",
  ].join("\n"),
